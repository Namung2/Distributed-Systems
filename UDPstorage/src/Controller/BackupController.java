...
public class BackupController {
    ...
    public void handleRequest(String method, String path, String body) {
        System.out.println("[DEBUG] handleRequest 호출: method=" + method + ", path=" + path + ", body=" + body);
        try {
    ...
    private void handlePost(String body) throws IOException {
        System.out.println("[DEBUG] handlePost 호출: body=" + body);
        if (body == null || body.isEmpty()) {
            System.err.println("[ERROR] 요청 본문이 비어 있습니다.");
            return;
        }
        try {
            System.out.println("[DEBUG] 저장 전 로컬 저장소 상태: " + localRepository.getAllNotes());
            ...
            System.out.println("[DEBUG] 저장 후 로컬 저장소 상태: " + localRepository.getAllNotes());
        } catch (Exception e) {
    ...
    private void handlePut(String path, String body) throws IOException {
        ...
        System.out.println("[DEBUG] PUT 요청 처리 완료: " + note);
    }
    ...
    private void handlePatch(String path, String body) throws IOException {
        ...
        System.out.println("[DEBUG] PATCH 요청 처리 완료: " + existingNote);
    }
