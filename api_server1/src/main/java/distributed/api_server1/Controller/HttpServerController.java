...
//postman사용시 클라이언트가 get으로 보내면 localhost:8081/api/register?action=register
//post로 보내면 localhost:8080/loadbalancer/regisger {"protocol":"api","port":"8081"} 라고등록

//브라우저 사용시 localhost:8081/api/register?action=register 이렇게 등록 해제는 action=unregister